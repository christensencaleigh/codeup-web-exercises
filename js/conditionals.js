 ...
 */
 switch(analyzeColor) {
     ...
     case 'red':
         ...
         break;
     case 'cyan':
         alert("I don't know anything about that" + analyzeColor)
         break;
     default:
         alert(analyzeColor());
         break;
...
alert(userInput + " is the color you picked.");
...
//               return billTotal - billTotal*.1;
//            case  3 :
//              alert("Your lucky number is " + luckyNumber * .35);
//              break;
//          case '4' :
//              alert("Your lucky number is " + luckyNumber * .50);
//              break;
//          case '5' :
//              alert("Your lucky number is " + luckyNumber * 1.0);
//              break;
//          default :
//              return billTotal;
//     }
...
//convert total bill to a number, so it can work with toFixed
totalBill = parseFloat(totalBill);
alert("your lucky number was: " + luckyNumber);
alert("your price before the discount was: $" + totalBill.toFixed(2));
alert("your new price is: $" + calculateTotal(luckyNumber, totalBill));
...
if(enterOrNot) {
    ...
    if (typeof parseFloat(userNumber) === "number") {
        ...
        //this means they did not type in a valid number, because parseFloat(userNum) did not result in a number
        alert("I'm sorry, that is a not a number. Please refresh.");
    }
}
